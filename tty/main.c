...
/* @brief   The "/dev/tty" device driver
 *
 * This driver acts as a placeholder. The kernel's pathname lookup code treats
 * character special files with a major/minor number of "5:0" as a special case
 * and redirects it to the current process's controlling TTY if any.
 *
 * No functionality is implemented in this driver.
 */
